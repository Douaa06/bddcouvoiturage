...
<form action="../home.php" method="get">
 ...
 $r = mysqli_query($conn, 'select * from utilisateur where Role="chauffeur"');
 ...
 if ($r->num_rows > 0) {
    ...
    while ($row = $r->fetch_assoc()) {
        ...
        <a href='mod_chauffeur.php? id=$row[Matrecule]'>modifier</a></t>
        <a href='supp_chauffeur.php? id=$row[Matrecule]'>supprimer</a></t>
        <a href=''>details</a></br>
        ";
    }
} else {
...
<form action="inserer.php" method="post" >
    ...
    <input type="submit" name="ajoutch" value="Insérer un chauffeur">
</form>
