...
$requete = "UPDATE trajet SET Chauffeur=$chauffeur,Lieu_depar= $lieu_depart, Lieu_arrive=$lieu_arrive, Date_depart=$date_depart,Heur_depart=$heur_depart, Nbr_place_max=$nb_place where id_trajet=$ID";
$conn->query($requete);
